...
#pipi_audacity.audacity_amplify(utils.convert_path(OUTPUT_AUDIO), utils.convert_path(AMPLIFIED_AUDIO), AMPLIFICATION_DB)

#pipi_audacity.audacity_amplify_compressor(utils.convert_path(OUTPUT_AUDIO), utils.convert_path(AMPLIFIED_AUDIO), "10","6")
